...
@app.route('/v1/repositories/<path:repository>/', methods=['DELETE', 'OPTIONS'])
@app.route('/v1/repositories/<path:repository>/tags', methods=['DELETE', 'OPTIONS'])
@flask_cors.cross_origin(methods=['DELETE'])  # allow all origins (*)
@toolkit.parse_repository_name
@toolkit.requires_auth
